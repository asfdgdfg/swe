...
class RLHFDataset(Dataset):
    ...
    def __getitem__(self, item):
        ...
        # Some task datasets serialize extra_info as JSON to avoid Arrow's
        # unsupported list-inside-struct conversion. Decode it before both the
        # generic metadata handling below and downstream environment creation.
