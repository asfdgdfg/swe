...
class AsyncvLLMServer(AsyncServerBase):
    ...
    async def init_engine(self):
        ...
        engine_args = AsyncEngineArgs(
            ...
            num_gpu_blocks_override=config.get("num_gpu_blocks_override", None),
        ...
        # rllm.router sends already chat-templated strings to the legacy text
        # completion endpoint and expects token ids encoded as ``token_id:N``.
